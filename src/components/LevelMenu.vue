    ...
    <div>
        <ul class="nav">
            ...
            <!-- <li v-if="!item.isHidden" :style="{
                fontSize: selectedIndex === index ? '20px' : '15px',
            ...
            <li v-for="(item, index) in filteredMenus" :key="item.path" :style="{
                fontSize: selectedIndex === index ? '20px' : '15px',
                color: selectedIndex === index ? '#1c1c1c' : 'rgb(102 102 102)'
            }" class="funItem" @click="menuClick(item.path, index)">
                <span>
                    <i :class="item.icon"></i>
                    <span>&nbsp; {{ item.name }}</span>
                </span>
            ...
            <li style="position: absolute;right: 155px;cursor: pointer;">
            ...
            <li style="position: absolute;right: 125px;">
                <el-badge style="margin-left: 5px;font-size: 16px;" v-if="noReadMsg" :value="noReadMsg">
                ...
                <span class="user-block">
                    <el-dropdown class="user-dropdown">
                        <span class="el-dropdown-link" style="display: flex; align-items: center;">
                            ...
                            <span class="userName"
                                style="margin-left: 5px;font-size: 16px;width: 50px;overflow: hidden;text-overflow: ellipsis;white-space: nowrap;">{{
                                    userInfo.name }}</span>
