    ...
    <div class="menu-container">
        <div class="menu-side" :class="{ 'menu-side-narrow': flag }">
            <div style="display: flex;align-items: center;">
                <Logo style="padding: 0 40px;margin: 10px 0;" sysName="运动健康" :flag="flag" :bag="colorLogo" />
            </div>
        ...
        <!-- 个人中心 -->
        <el-dialog :show-close="false" :visible.sync="dialogOperaion" width="26%" @close="handleCancel">
