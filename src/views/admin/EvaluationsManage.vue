    ...
    <el-row style="background-color: #FFFFFF;padding: 10px 0;border-radius: 5px;">
        <el-row style="padding: 10px;margin: 0 10px;">
            <el-row>
                ...
                <span class="top-bar">内容</span>
                <el-input size="small" style="width: 120px;" v-model="evalustionsQueryDto.content" placeholder="评论内容"
        ...
        <el-row style="margin: 10px;">
            <el-table row-key="id" @selection-change="handleSelectionChange" :data="tableData" style="width: 100%">
                ...
                <el-table-column prop="replierName" width="120" label="被评者">
                    <template slot-scope="scope">
                ...
                <el-table-column prop="createTime" width="168" label="评论时间" :sortable="true">
                    <template slot-scope="scope">
