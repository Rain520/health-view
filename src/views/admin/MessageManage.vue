    ...
    <el-row style="background-color: #FFFFFF;padding: 10px 0;border-radius: 5px;">
        <el-row style="padding: 10px 0 20px;border-bottom: 1px solid #f1f1f1;margin: 0 10px;">
            <el-row>
                ...
                <el-select size="small" style="width: 120px;" v-model="messageQueryDto.messageType" placeholder="请选择" clearable
                ...
                <el-input size="small" style="width: 120px;" v-model="messageQueryDto.content" placeholder="输入处"
                ...
                <el-select size="small" style="width: 120px; user-select: none; margin-right: 20px;"
                    v-model="messageQueryDto.isRead" placeholder="请选择" clearable
                    @clear="handleFilterClear">
        ...
        <el-row style="margin: 10px;">
            <el-table row-key="id" @selection-change="handleSelectionChange" :data="tableData" style="width: 100%">
                ...
                <el-table-column prop="name" width="90" label="读取状态">
                    <template slot-scope="scope">
                        <span>{{ scope.row.isRead ? '已读' : '未读' }}</span>
                    </template>
                </el-table-column>
                <el-table-column prop="messageType" width="100" label="消息类型">
                    <template slot-scope="scope">
                ...
                <el-table-column prop="senderName" width="100" label="发送者"></el-table-column>
                <el-table-column prop="receiverName" width="100" label="接收者"></el-table-column>
                <el-table-column prop="content" width="258" label="消息体"></el-table-column>
                <el-table-column prop="evaluationsContent" width="180" label="关联内容"></el-table-column>
                <el-table-column prop="createTime" width="168" label="发送时间" :sortable="true"></el-table-column>
