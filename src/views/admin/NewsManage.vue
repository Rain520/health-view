    ...
    <el-row style="background-color: #FFFFFF;padding: 10px 0;border-radius: 5px;">
        <el-row style="padding: 10px 0 20px;border-bottom: 1px solid #f1f1f1;margin: 0 10px;">
            <el-row>
                ...
                <el-input size="small" style="width: 120px;" v-model="newsQueryDto.name" placeholder="输入处" clearable
                    @clear="handleFilterClear">
                </el-input>
                <span class="top-bar">分类</span>
                <el-select style="width: 120px;" size="small" v-model="newsQueryDto.tagId" placeholder="请选择" clearable
                @clear="handleFilterClear">
                ...
                <el-select size="small" style="width: 120px; user-select: none; margin-right: 20px;"
                    v-model="newsQueryDto.isTop" placeholder="请选择" clearable
                    @clear="handleFilterClear">
        ...
        <el-row style="margin: 10px;">
            <el-table row-key="id" @selection-change="handleSelectionChange" :data="tableData" style="width: 100%">
                ...
                <el-table-column prop="isTop" width="148" label="是否推荐">
                    <template slot-scope="scope">
                        <span>{{ scope.row.isTop ? '已推荐' : '未推荐' }}</span>
                    </template>
                </el-table-column>
                <el-table-column prop="createTime" width="168" label="发布时间" :sortable="true"></el-table-column>
        ...
        <el-dialog :show-close="false" :visible.sync="dialogUserOperaion" width="50%">
            ...
            <div style="padding:0 20px;">
                ...
                <el-row>
                    ...
                    <input class="dialog-input" v-model="data.name" placeholder="标题" />
                </el-row>
                <!-- 封面 -->
                <p>封面</p>
                <el-row style="margin-top: 20px;">
