<template>
    <div class="login-container">
        <div class="login-panel">
            <div class="logo">
                <Logo :bag="colorLogo" sysName="运动健康"/>
            </div>
            <div class="text">
                <input v-model="act" class="act" placeholder="账号" @keydown.enter="login"/>
            </div>
            <div class="text">
                <input v-model="pwd" class="pwd" type="password" placeholder="密码" @keydown.enter="login" />
            </div>
            <div>
